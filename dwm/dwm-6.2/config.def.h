...
// Colorscheme by wal
static const char norm_fg[]	      = "#e1e2ec";
static const char norm_bg[]           = "#000001";
static const char norm_border[]       = "#e1e2ec";

static const char sel_fg[]            = "#e1e2ec";
static const char sel_bg[]            = "#6288B9";
static const char sel_border[]        = "#6288B9";
...
static const char *dmenucmd[] = { "dmenu_run", "-c", "-l", "15", "-g", "3", "-m", dmenumon, "-fn", dmenufont, "-nb", norm_bg, "-nf", norm_fg, "-sb", sel_bg, "-sf", sel_fg, NULL };
